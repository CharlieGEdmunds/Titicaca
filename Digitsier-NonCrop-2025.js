...
var veg = processLayer(NaturalVegetation_2025, 'natural');
var rock = processLayer(Rocky_2025, 'rocky');
var water = processLayer(Water_2025, 'water');
var res = processLayer(Residential_2025, 'residential');

var collection2025_Final = ee.FeatureCollection([veg, rock, water, res]).flatten();

Export.table.toAsset({
  collection: collection2025_Final,
  description: 'Training_Polygons_2025',
  assetId: 'Training_Polygons_2025'
});
