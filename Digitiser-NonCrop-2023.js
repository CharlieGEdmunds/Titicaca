...
var veg = processLayer(NaturalVegetation_2023, 'natural');
var rock = processLayer(Rocky_2023, 'rocky');
var water = processLayer(Water_2023, 'water');
var res = processLayer(Residential_2023, 'residential');

var collection2023_Final = ee.FeatureCollection([veg, rock, water, res]).flatten();

Export.table.toAsset({
  collection: collection2023_Final,
  description: 'Training_Polygons_2023',
  assetId: 'Training_Polygons_2023'
});
